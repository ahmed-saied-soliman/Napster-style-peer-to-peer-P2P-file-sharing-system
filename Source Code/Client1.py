...
if __name__ == "__main__":
    client1 = ThreadedServer(Client1, hostname=SERVER, port=PORT1)
    client_server_thread = Thread(target=client1.start)
    ...
    while True:
        ...
        if selection == '1':
            ...
            while len(Files)<Fileslen:
                ...
                Files.append(File)
            print(conn.root.exposed_Register(PORT1,Files))
            Files=[]
        elif selection == '2':
            ...
            conn.root.exposed_Terminate(PORT1)
            quit()
