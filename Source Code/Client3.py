...
if __name__ == "__main__":
    client3 = ThreadedServer(Client3, hostname=SERVER, port=PORT3)
    client_server_thread = Thread(target=client3.start)
    ...
    while True:
        ...
        if selection == '1':
            ...
            while len(Files) < Fileslen:
                ...
                Files.append(File)
            print(conn.root.exposed_Register(PORT3, Files))
            Files = []
        elif selection == '2':
            ...
            conn.root.exposed_Terminate(PORT3)
            quit()
