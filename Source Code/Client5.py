...
if __name__ == "__main__":
    client5 = ThreadedServer(Client5, hostname=SERVER, port=PORT5)
    client_server_thread = Thread(target=client5.start)
    ...
    while True:
        ...
        if selection == '1':
            ...
            while len(Files)<Fileslen:
                ...
                Files.append(File)
            print(conn.root.exposed_Register(PORT5,Files))
            Files=[]
        elif selection == '2':
            ...
            conn.root.exposed_Terminate(PORT5)
            quit()
