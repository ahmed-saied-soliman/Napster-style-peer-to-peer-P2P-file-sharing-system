...
if __name__ == "__main__":
    client4 = ThreadedServer(Client4, hostname=SERVER, port=PORT4)
    client_server_thread = Thread(target=client4.start)
    ...
    while True:
        ...
        if selection == '1':
            ...
            while len(Files)<Fileslen:
                ...
                Files.append(File)
            print(conn.root.exposed_Register(PORT4,Files))
            Files=[]
        elif selection == '2':
            ...
            conn.root.exposed_Terminate(PORT4)
            quit()
